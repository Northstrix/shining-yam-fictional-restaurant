...
export default function Home() {
  ...
  <div style={{ overflowX: 'hidden', width: '100%' }}>
    ...
    <div
      ...
      style={{
        minHeight: window.innerWidth >= 1024 ? 'calc(100vh - 69px)' : 'auto',
        maxWidth: MAX_VIEWPORT_WIDTH,
    ...
    >
      <SequenceHeroSection 
        ...
        carouselImages={[
          "/pexels-doraklimova-9928336.jpg",
          "/pexels-n-voitkevich-6275096.jpg",
          "https://images.unsplash.com/photo-1533622597524-a1215e26c0a2?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
          "/pexels-nicola-barts-7937351.jpg",
        ]}
        profiles={[
          { 
            name: "Tamar Mendelson", 
    ...
    >
      <div
        ...
        style={{
          minHeight: window.innerWidth >= MAX_FOOD_CONTAINER_WIDTH ? 'calc(100vh - 37px)' : 'auto',
          maxWidth: MAX_VIEWPORT_WIDTH,
          margin: '0 auto',
          paddingBottom: '32px',
           ...
           >
            <div
              style={{
                ...
                paddingLeft: window.innerWidth >= DESKTOP_THRESHOLD ? 'var(--desktop-horizontal-padding)' : 'var(--mobile-horizontal-padding)',
                paddingRight: window.innerWidth >= DESKTOP_THRESHOLD ? 'var(--desktop-horizontal-padding)' : 'var(--mobile-horizontal-padding)',
                paddingTop: window.innerWidth >= DESKTOP_THRESHOLD ? '40px' : '20px',
                paddingBottom: '20px',
    ...
    style={{
        minHeight: window.innerWidth >= 1024 ? 'calc(100vh - 18px)' : 'auto',
        maxWidth: MAX_VIEWPORT_WIDTH,
        margin: '0 auto', // Center the div horizontally
          ...
          >
            ...
            >
              ...
              >
                <ProductCard
                  id="Shakshouka"
                  imageSrc="/pexels-n-voitkevich-6275158.jpg"
                  altText="Shakshouka"
                  price="$21.99"
                  condition="20 min."
                  discountTag="Dairy"
        ...
        >
          ...
          >
            ...
            >
              <AboutUsSection
                aboutUsImages={[
                  "/eaters-collective-12eHC6FxPyg-unsplash.jpg",
