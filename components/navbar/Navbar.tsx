          ...
          {isFancyNavBarVisible && (
            <FancyNavBar
              items={[
                ...
                { icon: <IconCalendar size={22} />, label: "Reservations" }, // Changed from Contact to Reservations
              ]}
              onItemClick={(index) => {
                const clickedItem = ["Home", "Food of the Day", "Customer Reviews", "Menu", "Events & Promotions", "About Us", "Reservations"][index];
